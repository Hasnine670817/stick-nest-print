...
export default function MoreProducts() {
  ...
  const more = products.filter(p => p.category === 'more' && p.is_active);
      ...
      <section className="bg-[#f37021] text-white py-12 px-4 sm:px-8">
        <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row justify-between items-center md:items-center">
          <div className="text-center md:text-left mb-6 md:mb-0">
            <h1 className="text-[40px] md:text-[48px] font-bold leading-tight mb-2">More products</h1>
        ...
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <p className="text-[16px] text-[#333333] leading-relaxed">
              Print more products in any shape or size on premium vinyl. Don't stress about quality and durability. Our more products feature a special laminate that protects them from exposure to wind, rain and sunlight. You can even put them in your dishwasher and have them come out looking brand new.
            </p>
          </div>
